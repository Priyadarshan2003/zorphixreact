...
>>>>>>> f1230cf4232a6e1cd6dcda4a602c6bba8bb1e6b8
          ...
          <div className="card">
            <div className="card__side card__side--front">
              ...
              <div className="card__details">
                <p>
                  Blinded by the screen from coding all day? Flaunt your
                  programming prowess as you code up solutions to algorithmic
                  challenges at this sprightly event.Join us and discover the
                  thrill of coding in a fun and interactive way!
                </p>
              </div>
            </div>
            <div className="card__side card__side--back card__side--back-3">
                ...
                <div className="card__price-box">
                  <p
                    ...
                    onClick={() =>
                      toggle(
                        "Plugs Out!",
                        "Blinded by the screen from coding all day? Flaunt your programming prowess as you code up solutions to algorithmic challenges at this sprightly event. From beginner-friendly challenges to advanced programming quests, our games will test your skills and unleash your creativity. Join us and discover the thrill of coding in a fun and interactive way!",
                        "Rex Milan",
                        "Siva Manoj Kumar",
                        "+91 73586 97901",
                        "+91 80722 32119",
          ...
          <div className="col-1-of-3">
            <div className="card">
              <div className="card__side card__side--front">
                ...
                <div className="card__details">
                  <p>
                    With the warmth of the networks and the coldness of
                    curiosity, Join us for the brainstorming event of identity
                    guessing, as the name speaks for itself, let's dive into our
                    very own cybersecurity event, THE GAME OF THREATS!
                  </p>
                </div>
              </div>
              <div className="card__side card__side--back card__side--back-1">
          ...
          <div className="col-1-of-3">
            <div className="card">
              <div className="card__side card__side--front">
                ...
                <div className="card__details">
                  <p>
                    Join us for an enthralling session of coding with a hint of
                    jazzy music! Here, the tech enthusiast delves into the world
                    of coding against the constant distraction of music that
                    makes you want to keep tapping your feet! Are you up for the
                    challenge? Let the beats and coding begin!
                  </p>
                </div>
              </div>
              <div className="card__side card__side--back card__side--back-3">
